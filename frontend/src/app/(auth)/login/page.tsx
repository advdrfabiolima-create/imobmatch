        ...
        <div className="relative z-10 space-y-8">
          ...
          <div className="flex items-center gap-3 pt-4 border-t border-white/20">
            <div className="flex -space-x-2">
              {["A", "B", "C", "D"].map((l) => (
                <div key={l} className="w-8 h-8 rounded-full bg-white/30 border-2 border-white flex items-center justify-center text-xs font-bold text-white">
                  {l}
                </div>
              ))}
            </div>
      ...
      <div className="w-full lg:w-1/2 flex flex-col items-center justify-center p-6 sm:p-12 bg-gray-50">
        ...
        <div className="w-full max-w-md">
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-8">
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
              ...
              <button
                ...
                className="w-full h-11 flex items-center justify-center gap-3 rounded-lg border border-gray-300 bg-white hover:bg-gray-50 transition-colors text-sm font-medium text-gray-700"
              >
          ...
          <p className="text-center text-xs text-gray-400 mt-4">
            Mais de 3.000 corretores já utilizam o ImobMatch.
          </p>
        </div>
      </div>
    </div>
