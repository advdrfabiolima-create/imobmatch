  ...
  return (
    <div>
      ...
      <div className="p-4 md:p-6">
        ...
        <p className="text-sm text-muted-foreground mb-4">{data?.total ?? 0} corretor(es) encontrado(s)</p>
                ...
                <CardContent className="p-5">
                  <div className="flex items-start gap-3 mb-4">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      {agent.creci && (
                        <span className="text-xs text-muted-foreground bg-muted border border-border px-1.5 py-0.5 rounded mt-0.5 inline-block">
                          {agent.creci}
                        </span>
                      )}
                    </div>
