    ...
    <section className="relative overflow-hidden" style={{ minHeight: "860px" }}>
      ...
      >
        ...
        <div className="relative min-h-[620px] lg:min-h-[700px]">
          ...
          {/* Photo */}
          <div
            className="absolute right-[-2%] top-[7%] w-[92%] max-w-[900px] lg:right-[-4%] lg:top-[3%] lg:w-[100%]"
            style={{
              opacity: visible ? 1 : 0,
          ...
          >
            <img
              ...
              style={{
                filter: "drop-shadow(0 28px 60px rgba(37,99,235,0.12))",
              }}
              draggable={false}
            />
          </div>
          ...
          <FloatingCard
            className="absolute left-[8%] top-[11%] z-20 px-5 py-4"
            style={{
              opacity: visible ? 1 : 0,
          ...
          <FloatingCard
            className="absolute left-[6%] top-[37%] z-20 w-[300px] px-5 py-4 lg:w-[330px]"
            style={{
              opacity: visible ? 1 : 0,
              transform: visible ? "translateY(0)" : "translateY(12px)",
          ...
          >
            ...
            <div className="mt-4 flex items-center gap-3 rounded-2xl border border-slate-100 bg-slate-50 px-3 py-2">
              <div className="flex -space-x-2">
                ...
                <div className="grid h-7 w-7 place-items-center rounded-full border-2 border-white bg-pink-500 text-[10px] font-bold text-white">A</div>
                <div className="grid h-7 w-7 place-items-center rounded-full border-2 border-white bg-emerald-500 text-[10px] font-bold text-white">R</div>
              </div>
          ...
          <FloatingCard
            className="absolute right-[5%] top-[12%] z-20 px-5 py-4"
            style={{
              opacity: visible ? 1 : 0,
              transform: visible ? "translateY(0)" : "translateY(12px)",
          ...
          >
            <div className="flex items-start gap-3">
              <div className="grid h-11 w-11 place-items-center rounded-2xl bg-amber-50 text-2xl border border-amber-100">
                <span className="text-amber-500">✓</span>
              </div>
              <div>
                <div className="text-sm text-slate-400">Compatibilidade</div>
                <div className="text-lg font-bold text-slate-800">Negócio</div>
                <div className="mt-0.5 text-xs text-slate-400">Match encontrado</div>
              </div>
            </div>
          </FloatingCard>
          ...
          <FloatingCard
            className="absolute bottom-[22%] left-[32%] z-20 px-5 py-4"
            style={{
              opacity: visible ? 1 : 0,
              transform: visible ? "translateY(0)" : "translateY(12px)",
          ...
          >
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <div className="flex items-center gap-1.5 text-sm font-medium text-emerald-500 mt-0.5">
          ...
          <FloatingCard
            className="absolute bottom-[9%] right-[4%] z-20 px-5 py-4 shadow-[0_20px_60px_rgba(16,185,129,0.18)]"
            style={{
              opacity: visible ? 1 : 0,
              transform: visible ? "translateY(0)" : "translateY(12px)",
          ...
          >
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <div className="text-[22px] font-black text-emerald-600">R$ 14.200</div>
              </div>
            </div>
            <div className="mt-3 rounded-full border border-emerald-200 bg-emerald-50 px-3 py-2 text-sm font-medium text-emerald-600 text-center">
              e sua parte neste match
            </div>
          </FloatingCard>
        </div>
      </div>
