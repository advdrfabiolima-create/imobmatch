    ...
    <section className="relative overflow-hidden lg:min-h-[820px]">
      ...
      >
        ...
        <div className="hidden lg:block relative lg:min-h-[800px]">
          ...
          <div aria-hidden="true" className="pointer-events-none absolute" style={{ width: 340, height: 260, left: "25%", top: "36%", borderRadius: "50%", filter: "blur(38px)", mixBlendMode: "screen", background: "radial-gradient(ellipse, rgba(255,245,220,0.55) 0%, rgba(255,200,120,0.22) 45%, transparent 75%)", zIndex: 1 }} />
          {/* Halo médio — mais quente, concentrado */}
          <div aria-hidden="true" className="pointer-events-none absolute" style={{ width: 200, height: 160, left: "30%", top: "40%", borderRadius: "50%", filter: "blur(22px)", mixBlendMode: "screen", background: "radial-gradient(ellipse, rgba(255,255,255,0.75) 0%, rgba(255,220,140,0.45) 40%, transparent 70%)", zIndex: 1 }} />
          {/* Núcleo brilhante — ponto focal */}
          <div aria-hidden="true" className="pointer-events-none absolute" style={{ width: 90, height: 70, left: "34%", top: "44%", borderRadius: "50%", filter: "blur(10px)", mixBlendMode: "screen", background: "radial-gradient(ellipse, rgba(255,255,255,0.95) 0%, rgba(255,235,180,0.70) 50%, transparent 100%)", zIndex: 1 }} />
          {/* Reflexo azul-violeta no contorno */}
          <div aria-hidden="true" className="pointer-events-none absolute" style={{ width: 260, height: 200, left: "27%", top: "38%", borderRadius: "50%", filter: "blur(30px)", mixBlendMode: "screen", background: "radial-gradient(ellipse, rgba(140,160,255,0.20) 0%, transparent 70%)", zIndex: 1 }} />
